...
with step3:
    ...
    with left:
        ...
        st.markdown(
            ...
            "Implement McLaughlin movement allocation rules (molars/cuspids/incisors + midline) "
            "and anchorage risk with growth considered.</div>",
            unsafe_allow_html=True,
        )
    ...
    with right:
        ...
        st.caption("MVP: numeric allocation placeholder. Next: Dolphin-style diagram with arrows and highlighted teeth.")

        # Placeholder allocation (replace later with real McLaughlin rules)
